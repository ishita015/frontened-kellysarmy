...
export class ValidationsService {
  ...
  location_validation = [Validators.required, Validators.minLength(3), Validators.maxLength(30)]; 
  postcode_validator = [Validators.required, Validators.minLength(5), Validators.maxLength(15),Validators.pattern('^[0-9]+$')];
